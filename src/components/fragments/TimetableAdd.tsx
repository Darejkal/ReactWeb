...
export type TimetableAddProps = {}
// export type TimetableAddState ={
//     email:string,
//     name:string,
//     classID:string,
//     password:string,
//     editable:boolean,
// }
export interface TimetableAddState {
  Mon: string,
  Tue: string,
  Wed: string,
  Thu: string,
...
export class TimetableAdd extends React.Component<TimetableAddProps, TimetableAddState> {
  constructor(props: TimetableAddProps) {
    super(props);
    this.state = {
      Mon: "dsdsd",
      Tue: "dsd",
    ...
    return (
      <div>
        ...
        <form className="InputForm">
          <p>Enter class to add Timetable for</p>
          <input type="text"
            name="classID"
                  ...
                  respone.json().then(
                    (preanswer: any) => {
                      ...
                      switch (answer.internalStatus) {
                        ...
                        //   break;
                        case CODE.EXISTED:
                          alert(`Timetable of class  ${timetableHolder.obj.classID} is already existed. If you want to make changes to class' timetable, please select edit.`);
                          this.setState({ editable: true });
                          break;
                        case CODE.FAILED:
                          alert(`Unknown error`);
